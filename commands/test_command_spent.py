...
class TestSpent(unittest.TestCase):
    ...
    def test_validate_spent_parameters(self):
        ...
        self.assertEqual(
            {"start_date": "2022-12", "end_date": "2023-01", "category": "takeaway"},
            executor.validate(["2022-12", "2023-01", "takeaway"]),
        )

        self.assertEqual(
            {"start_date": "2022-12", "end_date": "2023-01", "category": "$each"},
            executor.validate(["2022-12", "2023-01"]),
        )

        self.assertEqual(
            {"start_date": "2022-12", "end_date": "2022-12", "category": "takeaway"},
        ...
        self.assertEqual(
            {"start_date": "2022-12", "end_date": "2022-12", "category": "$each"}, executor.validate(["2022-12"])
        )
